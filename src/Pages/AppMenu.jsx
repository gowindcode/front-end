...
//   const logoClickToLogin = () => {
//     navigate("/login");
//   }

//   const logoClickToAboutus = () => {
//     navigate("/aboutus");
//   }
//   const handleSignout = () => {
//     dispatch({ type: "LOGOUT" }); // Dispatch the logout action
...
//   const offMenu = [
//     { icon: <img src={Logo} alt="Logo" className="logo" onClick={logoClickToLogin}  /> },
//     { key: "/" },
//     { label: "Signup", key: "/signup" },
//     { label: "Login", key: "/login" },
//   ];
...
//   const menuItems = [
//     { icon: <img src={Logo} alt="Logo" className="logo" onClick={logoClickToAboutus}/> },
//     { icon: <HomeOutlined style={{ fontSize: 22 }} />, key: "/home" },
//     { label: "Diet Benifits", key: "/diet-benifits" },
//     { label: "Diet Foods", key: "/diet-foods" },
//     { label: "Diet Tips", key: "/diet-tips" },
...
function AppMenu({ isLoggedIn, isInline = false, dispatch }) {
  ...
  const menuToRender = currentPath.startsWith("/signup") ||
